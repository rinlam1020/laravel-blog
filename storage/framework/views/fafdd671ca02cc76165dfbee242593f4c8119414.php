...
<?php $component->withAttributes(['class' => 'bg-primary text-light m-2']); ?>
    <div class="row justify-content-between">
        <i class="fa fa-comments fa-5x" aria-hidden="true"></i>
        <div class="text-right">
            <div class="huge"><?php echo e($comments->count()); ?></div>
            <div><?php echo e(trans_choice('comments.new_comments', $comments->count())); ?></div>
        </div>
    </div>

     <?php $__env->slot('footer'); ?> 
        <a href="<?php echo e(route('admin.comments.index')); ?>" class="d-flex justify-content-between text-light">
...
<?php endif; ?>
<?php /**PATH /Users/rin/Sites/laravel-blog/resources/views/admin/dashboard/_comments.blade.php ENDPATH**/ ?>